...
Namespace NativeXtraReportExample.Module.Win.Controllers
	...
	Public Class ReportParameters
		Private privateSubjectContains As String
		Public Property SubjectContains() As String
			Get
				Return privateSubjectContains
			End Get
			Set(ByVal value As String)
				privateSubjectContains = value
			End Set
		End Property
		Private privateDeadlineBefore As DateTime
		Public Property DeadlineBefore() As DateTime
			Get
				Return privateDeadlineBefore
			End Get
			Set(ByVal value As DateTime)
				privateDeadlineBefore = value
			End Set
		End Property
	End Class
End Namespace