...
Namespace NativeXtraReportExample.Win
    ...
    Partial Public Class NativeXtraReportExampleWindowsFormsApplication
        ...
        End Sub
        Private Sub NativeXtraReportExampleWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles Me.CustomizeLanguagesList
            ...
            End If
        End Sub
        Private Sub NativeXtraReportExampleWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
    End Class
